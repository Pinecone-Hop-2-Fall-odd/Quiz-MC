export const MOIVE_QUESTIONS = [
  {
    source: "movie/8.webp",
    question: "What year was the titanic released?",
    type: "image",
    answers: [
      {
        answer: "1996",
  ...
  {
    source: "movie/5.webp",
    question: "What movies are in the IMDb top 250?",
    type: "image",
    answers: [
      {
        answer: "your name",
  ...
  {
    source: "movie/4.jpg",
    question: "What name is the next season of the hobbit",
    type: "image",
    answers: [
      {
        answer: "game of throns",
        inCorrect: false,
      },
      {
        answer: "thor",
  ...
  {
    source: "movie/1.webp",
    question: "what is the godfather imdb rating",
    type: "image",
    answers: [
      {
        answer: "9.2 rating",
  ...
  {
    source: "movie/7.jpg",
    question: "In what year was the first Oscar ceremony held?",
    type: "image",
    answers: [
      {
        answer: "may 15 1979 year",
        inCorrect: false,
      },
      {
        answer: "dec 15 1929 year",
        inCorrect: false,
      },
      {
        answer: "sep 25 1929 year",
        inCorrect: false,
      },
      {
        answer: "may 15 1929 year",
        inCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        answer: "disney&dream Works",
        inCorrect: false,
      },
      {
        answer: "pixar&sony pictures",
        inCorrect: false,
      },
      {
        answer: "sony pictures&dream Works",
        inCorrect: false,
      },
    ],
  },
  ...
  {
    source: "movie/3.webp",
    question: "what magical stick name in the harry potter",
    type: "image",
    answers: [
      {
        answer: "holly",
      ...
      {
        answer: "Tom Riddle's wand",
        inCorrect: false,
      },
      {
        answer: "Snatcher's wand",
        inCorrect: false,
      },
      {
        answer: "Elder Wand",
  ...
  {
    source: "movie/3.webp",
    question: "what oscars total in the harry potter?",
    type: "image",
    answers: [
      {
        answer: "12",
  ...
  {
    source: "movie/1.webp",
    question: "Which imdb godfather top 250 hyde write?",
    type: "image",
    answers: [
      {
        answer: "1",
...
export const ANIME_QUESTIONS = [
  ...
  {
    source: "anime-s/an-6.webp",
    question: "What is the name of character",
    type: "image",
    answers: [
      {
        answer: "Android17",
